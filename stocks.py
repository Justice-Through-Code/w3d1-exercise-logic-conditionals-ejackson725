...
def stock_purchases():
    ...
    dollars_to_invest = int(input("How much would you like to invest? $"))
    ...
    if stock_name == 'Amazon':
        number_of_stocks = int(dollars_to_invest / amazon)
        print(f'{client_name} has ${dollars_to_invest} to invest and can buy {number_of_stocks} shares of {stock_name} at the current price of ${amazon}.')
    elif stock_name == 'Apple':
        number_of_stocks = int(dollars_to_invest / apple)
        print(f'{client_name} has ${dollars_to_invest} to invest and can buy {number_of_stocks} shares of {stock_name} at the current price of ${apple}.')
    elif stock_name == 'Facebook':
        number_of_stocks = int(dollars_to_invest / fb)
        print(f'{client_name} has ${dollars_to_invest} to invest and can buy {number_of_stocks} shares of {stock_name} at the current price of ${fb}.')
    elif stock_name == 'Google':
        number_of_stocks = int(dollars_to_invest / google)
        print(f'{client_name} has ${dollars_to_invest} to invest and can buy {number_of_stocks} shares of {stock_name} at the current price of ${google}.')
    elif stock_name == 'Microsoft':
        number_of_stocks = int(dollars_to_invest / msft)
        print(f'{client_name} has ${dollars_to_invest} to invest and can buy {number_of_stocks} shares of {stock_name} at the current price of ${msft}.')
    else:
